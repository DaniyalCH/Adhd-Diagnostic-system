...
import 'package:dyslexia/pages/discalculia/level2/round1/L2R1Q2.dart';
...
class DL2R1Q1 extends StatefulWidget {
  const DL2R1Q1({Key? key}) : super(key: key);

  @override
  State<DL2R1Q1> createState() => _DL2R1Q1State();
}

class _DL2R1Q1State extends State<DL2R1Q1> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL2R1Q2()));
                },
