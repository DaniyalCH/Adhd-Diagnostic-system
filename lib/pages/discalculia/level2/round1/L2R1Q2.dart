...
import 'package:dyslexia/pages/discalculia/level2/round1/L2R1Q3.dart';
...
class DL2R1Q2 extends StatefulWidget {
  const DL2R1Q2({Key? key}) : super(key: key);

  @override
  State<DL2R1Q2> createState() => _DL2R1Q2State();
}

class _DL2R1Q2State extends State<DL2R1Q2> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL2R1Q3()));
                },
