...
import 'package:dyslexia/pages/discalculia/level2/round1/L2R1Q5.dart';
...
class DL2R1Q4 extends StatefulWidget {
  const DL2R1Q4({Key? key}) : super(key: key);

  @override
  State<DL2R1Q4> createState() => _DL2R1Q4State();
}

class _DL2R1Q4State extends State<DL2R1Q4> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL2R1Q5()));
                },
