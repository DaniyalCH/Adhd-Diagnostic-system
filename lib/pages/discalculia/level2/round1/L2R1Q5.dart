...
import 'package:dyslexia/pages/discalculia/level2/round2/L2R2Q1.dart';
...
class DL2R1Q5 extends StatefulWidget {
  const DL2R1Q5({Key? key}) : super(key: key);

  @override
  State<DL2R1Q5> createState() => _DL2R1Q5State();
}

class _DL2R1Q5State extends State<DL2R1Q5> {
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                        ...
                        child: SizedBox(child: Text("88*7"))),
                    SizedBox(
                      width: 40,
                    ),
                    Icon(TablerIcons.list_numbers),
                    ElevatedButton(
                        ...
                        child: SizedBox(child: Text("56*8"))),
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ...
                    ElevatedButton(
                        ...
                        child: SizedBox(child: Text("89*8"))),
                    SizedBox(
                      width: 40,
                    ),
                    Icon(TablerIcons.list_numbers),
                    ElevatedButton(
                        ...
                        child: SizedBox(child: Text("88*89"))),
                  ],
                )
              ]),
            ),
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL2R2Q1()));
                },
