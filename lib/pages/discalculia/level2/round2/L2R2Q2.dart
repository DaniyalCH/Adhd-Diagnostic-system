...
import 'dart:async';
import 'package:dyslexia/pages/discalculia/level2/round2/L2R2Q3.dart';
...
class DL2R2Q2 extends StatefulWidget {
  const DL2R2Q2({Key? key}) : super(key: key);

  @override
  State<DL2R2Q2> createState() => _DL2R2Q2State();
}

class _DL2R2Q2State extends State<DL2R2Q2> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL2R2Q3()));
                },
