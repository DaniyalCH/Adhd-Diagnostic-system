...
import 'dart:async';
import 'package:dyslexia/pages/discalculia/level2/round2/L2R2Q4.dart';
...
class DL2R2Q3 extends StatefulWidget {
  const DL2R2Q3({Key? key}) : super(key: key);

  @override
  State<DL2R2Q3> createState() => _DL2R2Q3State();
}

class _DL2R2Q3State extends State<DL2R2Q3> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL2R2Q4()));
                },
