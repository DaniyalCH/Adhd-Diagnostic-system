...
import 'dart:async';
import 'package:dyslexia/pages/discalculia/level2/round2/L2R2Q5.dart';
...
class DL2R2Q4 extends StatefulWidget {
  const DL2R2Q4({Key? key}) : super(key: key);

  @override
  State<DL2R2Q4> createState() => _DL2R2Q4State();
}

class _DL2R2Q4State extends State<DL2R2Q4> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL2R2Q5()));
                },
