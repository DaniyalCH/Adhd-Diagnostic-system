...
import 'dart:async';
import 'package:dyslexia/pages/discalculia/level2/round3/L2R3Q1.dart';
...
class DL2R2Q5 extends StatefulWidget {
  const DL2R2Q5({Key? key}) : super(key: key);

  @override
  State<DL2R2Q5> createState() => _DL2R2Q5State();
}

class _DL2R2Q5State extends State<DL2R2Q5> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL2R3Q1()));
                },
