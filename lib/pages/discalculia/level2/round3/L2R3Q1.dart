...
import 'dart:async';
import 'package:dyslexia/pages/discalculia/level2/round3/L2R3Q2.dart';
...
class DL2R3Q1 extends StatefulWidget {
  const DL2R3Q1({Key? key}) : super(key: key);

  @override
  State<DL2R3Q1> createState() => _DL2R3Q1State();
}

class _DL2R3Q1State extends State<DL2R3Q1> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL2R3Q2()));
                },
