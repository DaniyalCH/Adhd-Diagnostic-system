...
import 'dart:async';
import 'package:dyslexia/pages/discalculia/level2/round3/L2R3Q5.dart';
...
class DL2R3Q4 extends StatefulWidget {
  const DL2R3Q4({Key? key}) : super(key: key);

  @override
  State<DL2R3Q4> createState() => _DL2R3Q4State();
}

class _DL2R3Q4State extends State<DL2R3Q4> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL2R3Q5()));
                },
