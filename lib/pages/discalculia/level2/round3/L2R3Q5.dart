...
import 'dart:async';
import 'package:dyslexia/pages/discalculia/level2/round4/L2R4Q1.dart';
...
class DL2R3Q5 extends StatefulWidget {
  const DL2R3Q5({Key? key}) : super(key: key);

  @override
  State<DL2R3Q5> createState() => _DL2R3Q5State();
}

class _DL2R3Q5State extends State<DL2R3Q5> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL2R4Q1()));
                },
