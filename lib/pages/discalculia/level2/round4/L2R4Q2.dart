...
import 'package:dyslexia/pages/discalculia/level2/round4/L2R4Q3.dart';
...
class DL2R4Q2 extends StatefulWidget {
  const DL2R4Q2({Key? key}) : super(key: key);

  @override
  State<DL2R4Q2> createState() => _DL2R4Q2State();
}

class _DL2R4Q2State extends State<DL2R4Q2> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL2R4Q3()));
              },
