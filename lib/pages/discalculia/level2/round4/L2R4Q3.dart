...
import 'package:dyslexia/pages/discalculia/level2/round4/L2R4Q4.dart';
...
class DL2R4Q3 extends StatefulWidget {
  const DL2R4Q3({Key? key}) : super(key: key);

  @override
  State<DL2R4Q3> createState() => _DL2R4Q3State();
}

class _DL2R4Q3State extends State<DL2R4Q3> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL2R4Q4()));
              },
