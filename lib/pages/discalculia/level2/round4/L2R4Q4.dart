...
import 'package:dyslexia/pages/discalculia/level2/round4/L2R4Q5.dart';
...
class DL2R4Q4 extends StatefulWidget {
  const DL2R4Q4({Key? key}) : super(key: key);

  @override
  State<DL2R4Q4> createState() => _DL2R4Q4State();
}

class _DL2R4Q4State extends State<DL2R4Q4> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL2R4Q5()));
              },
