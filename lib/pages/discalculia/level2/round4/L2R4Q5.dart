...
import 'package:dyslexia/pages/discalculia/level2/round5/L2R5Q1.dart';
...
class DL2R4Q5 extends StatefulWidget {
  const DL2R4Q5({Key? key}) : super(key: key);

  @override
  State<DL2R4Q5> createState() => _DL2R4Q5State();
}

class _DL2R4Q5State extends State<DL2R4Q5> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL2R5Q1()));
              },
