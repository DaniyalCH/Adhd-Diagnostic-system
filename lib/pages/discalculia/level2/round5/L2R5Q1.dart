...
class DL2R5Q1 extends StatefulWidget {
  const DL2R5Q1({Key? key}) : super(key: key);

  @override
  State<DL2R5Q1> createState() => _DL2R5Q1State();
}

class _DL2R5Q1State extends State<DL2R5Q1> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL2R5Q2()));
              },
