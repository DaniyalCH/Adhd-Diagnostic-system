...
import 'package:dyslexia/pages/discalculia/level2/round5/L2R5Q4.dart';
...
class DL2R5Q3 extends StatefulWidget {
  const DL2R5Q3({Key? key}) : super(key: key);

  @override
  State<DL2R5Q3> createState() => _DL2R5Q3tate();
}

class _DL2R5Q3tate extends State<DL2R5Q3> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL2R5Q4()));
              },
