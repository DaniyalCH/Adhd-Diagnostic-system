...
import 'package:dyslexia/pages/discalculia/level2/round5/L2R5Q5.dart';
...
class DL2R5Q4 extends StatefulWidget {
  const DL2R5Q4({Key? key}) : super(key: key);

  @override
  State<DL2R5Q4> createState() => _DL2R5Q4State();
}

class _DL2R5Q4State extends State<DL2R5Q4> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL2R5Q5()));
              },
