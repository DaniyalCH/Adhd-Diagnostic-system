...
import 'package:dyslexia/pages/discalculia/level2/round5/discalculiacoreBoardL2.dart';
...
class DL2R5Q5 extends StatefulWidget {
  const DL2R5Q5({Key? key}) : super(key: key);

  @override
  State<DL2R5Q5> createState() => _DL2R5Q5State();
}

class _DL2R5Q5State extends State<DL2R5Q5> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(MaterialPageRoute(
                    builder: (context) => const ScoreBoardDisL2()));
              },
