...
import 'package:dyslexia/pages/discalculia/level3/round1/L3R1Q2.dart';
...
class DL3R1Q1 extends StatefulWidget {
  const DL3R1Q1({Key? key}) : super(key: key);

  @override
  State<DL3R1Q1> createState() => _DL3R1Q1State();
}

class _DL3R1Q1State extends State<DL3R1Q1> {
  String question = "Click on the smaller number";
            ...
            Wrap(
                ...
                children: [
                  ...
                  ElevatedButton(
                      ...
                      child: SizedBox(child: Text("89+50"))),
                  Icon(TablerIcons.list_numbers),
                  ElevatedButton(
                      onPressed: (() {
                        clicksPerpage += 1;
                      ...
                      child: SizedBox(child: Text("76+55")))
                ]),
            SizedBox(height: MediaQuery.of(context).size.height * 0.05),
            Material(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL3R1Q2()));
                },
