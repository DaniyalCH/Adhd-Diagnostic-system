...
import 'package:dyslexia/pages/discalculia/level3/round1/L3R1Q3.dart';
...
class DL3R1Q2 extends StatefulWidget {
  const DL3R1Q2({Key? key}) : super(key: key);

  @override
  State<DL3R1Q2> createState() => _DL3R1Q2State();
}

class _DL3R1Q2State extends State<DL3R1Q2> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL3R1Q3()));
                },
