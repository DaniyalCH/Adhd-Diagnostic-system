...
import 'package:dyslexia/pages/discalculia/level3/round1/L3R1Q4.dart';
...
class DL3R1Q3 extends StatefulWidget {
  const DL3R1Q3({Key? key}) : super(key: key);

  @override
  State<DL3R1Q3> createState() => _DL3R1Q3State();
}

class _DL3R1Q3State extends State<DL3R1Q3> {
            ...
            Wrap(
                ...
                children: [
                  ...
                  ElevatedButton(
                      ...
                      child: SizedBox(child: Text("96+4"))),
                  Icon(TablerIcons.list_numbers),
                  ElevatedButton(
                      onPressed: (() {
                        clicksPerpage += 1;
                      ...
                      child: SizedBox(child: Text("69+4")))
                ]),
            SizedBox(height: MediaQuery.of(context).size.height * 0.05),
            Material(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL3R1Q4()));
                },
