...
import 'package:dyslexia/pages/discalculia/level3/round1/L3R1Q5.dart';
...
class DL3R1Q4 extends StatefulWidget {
  const DL3R1Q4({Key? key}) : super(key: key);

  @override
  State<DL3R1Q4> createState() => _DL3R1Q4State();
}

class _DL3R1Q4State extends State<DL3R1Q4> {
  String question = "Click on the smallest number";
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                        ...
                        child: SizedBox(child: Text("55 - 48"))),
                    SizedBox(
                      width: 40,
                    ),
                    Icon(TablerIcons.list_numbers),
                    ElevatedButton(
                        ...
                        child: SizedBox(child: Text("35 + 17"))),
                  ],
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    ...
                    ElevatedButton(
                        ...
                        child: SizedBox(child: Text("69 - 47"))),
                    SizedBox(
                      width: 40,
                    ),
                    Icon(TablerIcons.list_numbers),
                    ElevatedButton(
                        ...
                        child: SizedBox(child: Text("75 - 86"))),
                  ],
                )
              ]),
            ),
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL3R1Q5()));
                },
