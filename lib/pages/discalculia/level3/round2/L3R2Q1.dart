...
import 'dart:async';
import 'package:dyslexia/pages/discalculia/level3/round2/L3R2Q2.dart';
...
class DL3R2Q1 extends StatefulWidget {
  const DL3R2Q1({Key? key}) : super(key: key);

  @override
  State<DL3R2Q1> createState() => _DL3R2Q1State();
}

class _DL3R2Q1State extends State<DL3R2Q1> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL3R2Q2()));
                },
