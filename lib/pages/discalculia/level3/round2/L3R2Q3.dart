...
import 'dart:async';
import 'package:dyslexia/pages/discalculia/level3/round2/L3R2Q4.dart';
...
class DL3R2Q3 extends StatefulWidget {
  const DL3R2Q3({Key? key}) : super(key: key);

  @override
  State<DL3R2Q3> createState() => _DL3R2Q3State();
}

class _DL3R2Q3State extends State<DL3R2Q3> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL3R2Q4()));
                },
