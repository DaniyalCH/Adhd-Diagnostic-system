...
import 'dart:async';
import 'package:dyslexia/pages/discalculia/level3/round2/L3R2Q5.dart';
...
class DL3R2Q4 extends StatefulWidget {
  const DL3R2Q4({Key? key}) : super(key: key);

  @override
  State<DL3R2Q4> createState() => _DL3R2Q4State();
}

class _DL3R2Q4State extends State<DL3R2Q4> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL3R2Q5()));
                },
