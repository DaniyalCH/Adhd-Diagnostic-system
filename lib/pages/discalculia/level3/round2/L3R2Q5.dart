...
import 'dart:async';
import 'package:dyslexia/pages/discalculia/level3/round3/L3R3Q1.dart';
...
class DL3R2Q5 extends StatefulWidget {
  const DL3R2Q5({Key? key}) : super(key: key);

  @override
  State<DL3R2Q5> createState() => _DL3R2Q5State();
}

class _DL3R2Q5State extends State<DL3R2Q5> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL3R3Q1()));
                },
