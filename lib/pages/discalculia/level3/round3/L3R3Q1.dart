...
import 'dart:async';
import 'package:dyslexia/pages/discalculia/level3/round3/L3R3Q2.dart';
...
class DL3R3Q1 extends StatefulWidget {
  const DL3R3Q1({Key? key}) : super(key: key);

  @override
  State<DL3R3Q1> createState() => _DL3R3Q1State();
}

class _DL3R3Q1State extends State<DL3R3Q1> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL3R3Q2()));
                },
