...
import 'dart:async';
import 'package:dyslexia/pages/discalculia/level3/round3/L3R3Q3.dart';
...
class DL3R3Q2 extends StatefulWidget {
  const DL3R3Q2({Key? key}) : super(key: key);

  @override
  State<DL3R3Q2> createState() => _DL3R3Q2State();
}

class _DL3R3Q2State extends State<DL3R3Q2> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL3R3Q3()));
                },
