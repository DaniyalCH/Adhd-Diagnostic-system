...
import 'dart:async';
import 'package:dyslexia/pages/discalculia/level3/round3/L3R3Q4.dart';
...
class DL3R3Q3 extends StatefulWidget {
  const DL3R3Q3({Key? key}) : super(key: key);

  @override
  State<DL3R3Q3> createState() => _DL3R3Q3State();
}

class _DL3R3Q3State extends State<DL3R3Q3> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL3R3Q4()));
                },
