...
class DL3R3Q5 extends StatefulWidget {
  const DL3R3Q5({Key? key}) : super(key: key);

  @override
  State<DL3R3Q5> createState() => _DL3R3Q5State();
}

class _DL3R3Q5State extends State<DL3R3Q5> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => DL3R4Q1()));
                },
