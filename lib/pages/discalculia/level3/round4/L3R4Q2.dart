...
import 'package:dyslexia/pages/discalculia/level3/round4/L3R4Q3.dart';
...
class DL3R4Q2 extends StatefulWidget {
  const DL3R4Q2({Key? key}) : super(key: key);

  @override
  State<DL3R4Q2> createState() => _DL3R4Q2State();
}

class _DL3R4Q2State extends State<DL3R4Q2> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL3R4Q3()));
              },
