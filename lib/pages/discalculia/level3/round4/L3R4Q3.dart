...
import 'package:dyslexia/pages/discalculia/level3/round4/L3R4Q4.dart';
...
class DL3R4Q3 extends StatefulWidget {
  const DL3R4Q3({Key? key}) : super(key: key);

  @override
  State<DL3R4Q3> createState() => _DL3R4Q3State();
}

class _DL3R4Q3State extends State<DL3R4Q3> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL3R4Q4()));
              },
