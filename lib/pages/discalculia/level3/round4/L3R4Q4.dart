...
import 'package:dyslexia/pages/discalculia/level3/round4/L3R4Q5.dart';
...
class DL3R4Q4 extends StatefulWidget {
  const DL3R4Q4({Key? key}) : super(key: key);

  @override
  State<DL3R4Q4> createState() => _DL3R4Q4State();
}

class _DL3R4Q4State extends State<DL3R4Q4> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL3R4Q5()));
              },
