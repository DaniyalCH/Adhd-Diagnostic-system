...
import 'package:dyslexia/pages/discalculia/level3/round5/L3R5Q1.dart';
...
class DL3R4Q5 extends StatefulWidget {
  const DL3R4Q5({Key? key}) : super(key: key);

  @override
  State<DL3R4Q5> createState() => _DL3R4Q5State();
}

class _DL3R4Q5State extends State<DL3R4Q5> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL3R5Q1()));
              },
