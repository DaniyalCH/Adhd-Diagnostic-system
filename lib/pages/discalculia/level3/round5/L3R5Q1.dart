...
import 'package:dyslexia/pages/discalculia/level3/round5/L3R5Q2.dart';
...
class DL3R5Q1 extends StatefulWidget {
  const DL3R5Q1({Key? key}) : super(key: key);

  @override
  State<DL3R5Q1> createState() => _DL3R5Q1State();
}

class _DL3R5Q1State extends State<DL3R5Q1> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL3R5Q2()));
              },
