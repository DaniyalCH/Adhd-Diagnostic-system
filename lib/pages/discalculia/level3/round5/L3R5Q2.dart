...
import 'package:dyslexia/pages/discalculia/level3/round5/L3R5Q3.dart';
...
class DL3R5Q2 extends StatefulWidget {
  const DL3R5Q2({Key? key}) : super(key: key);

  @override
  State<DL3R5Q2> createState() => _DL3R5Q2State();
}

class _DL3R5Q2State extends State<DL3R5Q2> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL3R5Q3()));
              },
