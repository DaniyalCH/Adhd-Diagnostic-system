...
import 'package:dyslexia/pages/discalculia/level3/round5/L3R5Q4.dart';
...
class DL3R5Q3 extends StatefulWidget {
  const DL3R5Q3({Key? key}) : super(key: key);

  @override
  State<DL3R5Q3> createState() => _DL3R5Q3State();
}

class _DL3R5Q3State extends State<DL3R5Q3> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL3R5Q4()));
              },
