...
import 'package:dyslexia/pages/discalculia/level3/round5/L3R5Q5.dart';
...
class DL3R5Q4 extends StatefulWidget {
  const DL3R5Q4({Key? key}) : super(key: key);

  @override
  State<DL3R5Q4> createState() => _DL3R5Q4State();
}

class _DL3R5Q4State extends State<DL3R5Q4> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL3R5Q5()));
              },
