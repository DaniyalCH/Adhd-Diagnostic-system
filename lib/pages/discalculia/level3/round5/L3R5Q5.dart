...
import 'package:dyslexia/pages/discalculia/level3/round4/L3R4Q2.dart';
...
class DL3R5Q5 extends StatefulWidget {
  const DL3R5Q5({Key? key}) : super(key: key);

  @override
  State<DL3R5Q5> createState() => _DL3R5Q5State();
}

class _DL3R5Q5State extends State<DL3R5Q5> {
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => const DL3R4Q2()));
              },
