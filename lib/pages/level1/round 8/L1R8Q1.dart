...
import 'package:dyslexia/pages/level1/round%208/L1R8Q2.dart';
...
class L1R8Q1 extends StatefulWidget {
  const L1R8Q1({Key? key}) : super(key: key);

  @override
  State<L1R8Q1> createState() => _L1R8Q1State();
}

class _L1R8Q1State extends State<L1R8Q1> {
                  ...
                  children: [
                    Material(
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: (() {
                            player.play(AssetSource("sound/fire.mp3"));
                        ...
                        child: dragged1
                            ...
                            : Material(
                                ...
                                child: Container(
                                  ...
                                  child: InkWell(
                                    onTap: (() {
                                      player.play(AssetSource("sound/f.mp3"));
                                      clicksPerpage += 1;
                                      timeIntervalClicks.add(timer.toInt());
                                      Timer(Duration(seconds: 4), () {
                                        if (mounted) {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => L1R8Q2()));
                },
