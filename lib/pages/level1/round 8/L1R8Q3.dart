...
import 'package:dyslexia/pages/level1/round%208/L1R8Q4.dart';
...
class L1R8Q3 extends StatefulWidget {
  const L1R8Q3({Key? key}) : super(key: key);

  @override
  State<L1R8Q3> createState() => _L1R8Q3State();
}

class _L1R8Q3State extends State<L1R8Q3> {
                        ...
                        child: dragged2
                            ...
                            : Material(
                                ...
                                child: Container(
                                  ...
                                  child: InkWell(
                                    onTap: (() {
                                      player.play(AssetSource("sound/L.mp3"));
                                      clicksPerpage += 1;
                                      timeIntervalClicks.add(timer.toInt());
                                      Timer(Duration(seconds: 4), () {
                                        if (mounted) {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => L1R8Q4()));
                },
