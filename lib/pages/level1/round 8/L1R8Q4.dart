...
class L1R8Q4 extends StatefulWidget {
  const L1R8Q4({Key? key}) : super(key: key);

  @override
  State<L1R8Q4> createState() => _L1R8Q4State();
}

class _L1R8Q4State extends State<L1R8Q4> {
                  ...
                  children: [
                    Material(
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: (() {
                            player.play(AssetSource("sound/good.mp3"));
                        ...
                        child: dragged1
                            ...
                            : Material(
                                ...
                                child: Container(
                                  ...
                                  child: InkWell(
                                    onTap: (() {
                                      player.play(AssetSource("sound/g.mp3"));
                                      clicksPerpage += 1;
                                      timeIntervalClicks.add(timer.toInt());
                                      Timer(Duration(seconds: 4), () {
                                        if (mounted) {
