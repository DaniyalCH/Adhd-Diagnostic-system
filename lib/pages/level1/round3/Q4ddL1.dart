...
class Q4L1R3 extends StatefulWidget {
  const Q4L1R3({Key? key}) : super(key: key);

  @override
  State<Q4L1R3> createState() => _Q4L1R3State();
}

class _Q4L1R3State extends State<Q4L1R3> {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => Q5L1R3()));
                },
