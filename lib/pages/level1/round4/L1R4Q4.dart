...
import 'dart:async';
import 'package:dyslexia/pages/level1/round4/L1R4Q5.dart';
...
class L1R4Q4 extends StatefulWidget {
  const L1R4Q4({Key? key}) : super(key: key);

  @override
  State<L1R4Q4> createState() => _L1R4Q4State();
}

class _L1R4Q4State extends State<L1R4Q4> {
  String question =
          ...
          Material(
            ...
            child: ListTile(
              onTap: () async {
                ...
                player.play(AssetSource("sound/z.mp3"));
                clicksPerpage += 1;
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => L1R4Q5()));
              },
