...
import 'package:dyslexia/pages/level1/round6/L1R6Q3.dart';
...
class L1R6Q2 extends StatefulWidget {
  const L1R6Q2({Key? key}) : super(key: key);

  @override
  State<L1R6Q2> createState() => _L1R6Q2State();
}

class _L1R6Q2State extends State<L1R6Q2> {
  String question =
      "Listen to this word mat. Now listen to the four words and click on the word that has the same starting sound as cat. ";
          ...
          child: Column(children: [
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Icon(
                isChecked1
                    ? TablerIcons.circle_check
                    : isChecked2 && isChecked4 && isChecked3
                        ? TablerIcons.circle_check
                  ...
                  children: [
                    Material(
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: (() {
                            player.play(AssetSource("sound/mat.mp3"));
                    ...
                    children: [
                      Material(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            onTap: (() {
                              player.play(AssetSource("sound/cat.mp3"));
                              clicksPerpage += 1;
                              timeIntervalClicks.add(timer.toInt());
                              Timer(Duration(seconds: 4), () {
                                if (mounted) {
                    ...
                    children: [
                      Material(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            onTap: (() {
                              player.play(AssetSource("sound/man.mp3"));
                              clicksPerpage += 1;
                              timeIntervalClicks.add(timer.toInt());
                              Timer(Duration(seconds: 4), () {
                                if (mounted) {
                      ...
                      Material(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            onTap: (() {
                              player.play(AssetSource("sound/tin.mp3"));
                              clicksPerpage += 1;
                              timeIntervalClicks.add(timer.toInt());
                              Timer(Duration(seconds: 4), () {
                                if (mounted) {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => L1R6Q3()));
                },
