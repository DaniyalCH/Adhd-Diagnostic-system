...
class L1R6Q4 extends StatefulWidget {
  const L1R6Q4({Key? key}) : super(key: key);

  @override
  State<L1R6Q4> createState() => _L1R6Q4State();
}

class _L1R6Q4State extends State<L1R6Q4> {
  String question =
      "Listen to this word rub. Now listen to the four words and click on the word that has the same starting sound as cat. ";
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Icon(
                isChecked1 && isChecked4
                    ? TablerIcons.circle_check
                    : isChecked2 && isChecked3
                        ? TablerIcons.circle_check
                        : TablerIcons.circle_dashed,
                size: 30,
                color: isChecked1 && isChecked4
                    ? Colors.green
                    : isChecked2 && isChecked3
                        ? Colors.red
                        : Colors.black,
                  ...
                  children: [
                    Material(
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: (() {
                            player.play(AssetSource("sound/rub.mp3"));
                    ...
                    children: [
                      Material(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            onTap: (() {
                              player.play(AssetSource("sound/tub.mp3"));
                              clicksPerpage += 1;
                      ...
                      Material(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            onTap: (() {
                              player.play(AssetSource("sound/rat.mp3"));
                              clicksPerpage += 1;
                              timeIntervalClicks.add(timer.toInt());
                              Timer(Duration(seconds: 4), () {
                                if (mounted) {
                    ...
                    children: [
                      Material(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            onTap: (() {
                              player.play(AssetSource("sound/bat.mp3"));
                              clicksPerpage += 1;
                              timeIntervalClicks.add(timer.toInt());
                              Timer(Duration(seconds: 4), () {
                                if (mounted) {
                      ...
                      Material(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            onTap: (() {
                              player.play(AssetSource("sound/cup.mp3"));
                              clicksPerpage += 1;
                              timeIntervalClicks.add(timer.toInt());
                              Timer(Duration(seconds: 4), () {
                                if (mounted) {
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => L1R7Q1()));
                },
