...
import 'package:dyslexia/pages/level1/round5/L1R5Q2.dart';
...
class L1R7Q4 extends StatefulWidget {
  const L1R7Q4({Key? key}) : super(key: key);

  @override
  State<L1R7Q4> createState() => _L1R7Q4State();
}

class _L1R7Q4State extends State<L1R7Q4> {
  String question =
      "Can you spell the word trash. Drag the letters to write the word";
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => L1R5Q2()));
                },
