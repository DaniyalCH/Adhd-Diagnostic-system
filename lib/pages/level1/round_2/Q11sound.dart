...
import 'package:dyslexia/pages/level1/round1/Q1shape.dart';
...
class Q11sound extends StatefulWidget {
  const Q11sound({Key? key}) : super(key: key);

  @override
  State<Q11sound> createState() => _Q11soundState();
}

class _Q11soundState extends State<Q11sound> {
  String question =
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(children: [
          ...
          Material(
            ...
            child: ListTile(
              onTap: () async {
                ...
                player.play(AssetSource("/sound/m.mp3"));
                isPlayingMsg = true;
                clicksPerpage += 1;
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => Q1Shape()));
              },
          ...
          //nextButton(changeButton: changeButton, Location: Q1DAD()),
        ]),
      ),
    );
  }
