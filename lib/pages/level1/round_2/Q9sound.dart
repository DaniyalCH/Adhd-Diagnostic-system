...
class Q9sound extends StatefulWidget {
  const Q9sound({Key? key}) : super(key: key);

  @override
  State<Q9sound> createState() => _Q9soundState();
}

class _Q9soundState extends State<Q9sound> {
  String question =
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => Q10sound()));
              },
