...
import 'package:dyslexia/pages/level2/round1/Q3sound.dart';
...
class Q2Sint extends StatefulWidget {
  const Q2Sint({Key? key}) : super(key: key);

  @override
  State<Q2Sint> createState() => _Q2SintState();
}

class _Q2SintState extends State<Q2Sint> {
  String question =
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => Q3Sint()));
              },
