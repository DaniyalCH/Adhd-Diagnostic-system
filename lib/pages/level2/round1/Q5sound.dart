...
import 'package:dyslexia/pages/level2/round2/Q1DADint.dart';
...
class Q5Sint extends StatefulWidget {
  const Q5Sint({Key? key}) : super(key: key);

  @override
  State<Q5Sint> createState() => _Q5SintState();
}

class _Q5SintState extends State<Q5Sint> {
  String question =
            ...
            child: InkWell(
              onTap: () {
                ...
                Navigator.of(context).pushReplacement(
                    MaterialPageRoute(builder: (context) => Q1DADint()));
              },
