...
import 'package:dyslexia/pages/level2/round2/Q3DADint.dart';
...
class Q2DADint extends StatefulWidget {
  const Q2DADint({Key? key}) : super(key: key);

  @override
  State<Q2DADint> createState() => _Q2DADintState();
}

class _Q2DADintState extends State<Q2DADint> {
  String question =
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => Q3DADint()));
                },
