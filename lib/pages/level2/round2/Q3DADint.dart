...
import 'package:dyslexia/pages/level2/round2/Q4DADint.dart';
...
class Q3DADint extends StatefulWidget {
  const Q3DADint({Key? key}) : super(key: key);

  @override
  State<Q3DADint> createState() => _Q3DADintState();
}

class _Q3DADintState extends State<Q3DADint> {
  String question =
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => Q4DADint()));
                },
