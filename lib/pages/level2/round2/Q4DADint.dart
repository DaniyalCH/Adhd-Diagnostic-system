...
import 'package:dyslexia/pages/level2/round2/Q5DADint.dart';
...
class Q4DADint extends StatefulWidget {
  const Q4DADint({Key? key}) : super(key: key);

  @override
  State<Q4DADint> createState() => _Q4DADintState();
}

class _Q4DADintState extends State<Q4DADint> {
  String question =
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => Q5DADint()));
                },
