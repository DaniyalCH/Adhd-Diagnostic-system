...
import 'package:dyslexia/pages/level2/round3/Q3spell.dart';
...
class Q2spell extends StatefulWidget {
  const Q2spell({Key? key}) : super(key: key);

  @override
  State<Q2spell> createState() => _Q2spellState();
}

class _Q2spellState extends State<Q2spell> {
  String question = "Can you spell tax?";
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Icon(
                letter1 == "t" && letter2 == "a" && letter3 == "x"
                    ? TablerIcons.circle_check
                    : letter1 == "d" || letter1 == "e"
                        ? TablerIcons.circle_check
                        : TablerIcons.circle_dashed,
                size: 30,
                color: letter1 == "t" && letter2 == "a" && letter3 == "x"
                    ? Colors.green
                    : letter1 == "d" || letter1 == "e"
                        ? Colors.red
                        : Colors.black,
                  ...
                  children: [
                    Material(
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: (() {
                            player.play(AssetSource("sound/tax.mp3"));
            ...
            Material(
              ...
              child: InkWell(
                onTap: () {
                  if (letter1 == "t" && letter2 == "a" && letter3 == "x") {
                    correctAns += 1;
                  } else {
                    incorrectAns += 1;
                  }
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => Q3spell()));
                },
