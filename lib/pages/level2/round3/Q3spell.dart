...
import 'package:dyslexia/pages/level2/round3/Q4spell.dart';
...
class Q3spell extends StatefulWidget {
  const Q3spell({Key? key}) : super(key: key);

  @override
  State<Q3spell> createState() => _Q3spellState();
}

class _Q3spellState extends State<Q3spell> {
  String question = "Can you spell mug?";
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Icon(
                letter1 == "m" && letter2 == "u" && letter3 == "g"
                    ? TablerIcons.circle_check
                    : letter1 == "a" || letter1 == "e"
                        ? TablerIcons.circle_check
                        : TablerIcons.circle_dashed,
                size: 30,
                color: letter1 == "m" && letter2 == "u" && letter3 == "g"
                    ? Colors.green
                    : letter1 == "a" || letter1 == "e"
                        ? Colors.red
                        : Colors.black,
                  ...
                  children: [
                    Material(
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: (() {
                            player.play(AssetSource("sound/mug.mp3"));
            ...
            Material(
              ...
              child: InkWell(
                onTap: () {
                  if (letter1 == "m" && letter2 == "u" && letter3 == "g") {
                    correctAns += 1;
                  } else {
                    incorrectAns += 1;
                  }
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => Q4spell()));
                },
