...
import 'package:dyslexia/pages/level2/round4/L2R4Q3.dart';
...
class L2R4Q2 extends StatefulWidget {
  const L2R4Q2({Key? key}) : super(key: key);

  @override
  State<L2R4Q2> createState() => _L2R4Q2State();
}

class _L2R4Q2State extends State<L2R4Q2> {
  ...
  var clock = "the orange clock";
  var oranges = "The oranges are in the basket";
  var icecream = "Lets get ice cream";
  ...
  Widget build(BuildContext context) {
    ...
    pic2 = Image(
      image: AssetImage("assets/images/$oranges.png"),
      height: 100,
      width: 80,
    );
    pic3 = Image(
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Icon(
                letter1 == icecream && letter2 == oranges && letter3 == clock
                    ? TablerIcons.circle_check
                    : TablerIcons.circle_dashed,
                size: 30,
                color: letter1 == icecream &&
                        letter2 == oranges &&
                        letter3 == clock
                    ? Colors.green
                    : Colors.black,
                  ...
                  children: [
                    ...
                    draged3
                        ...
                        : Draggable(
                            ...
                            data: "The oranges are in the basket",
                            feedback: pic2,
                            childWhenDragging: SizedBox()),
                  ]),
            ),
                  ...
                  Row(
                    ...
                    children: [
                      SizedBox(
                          height: 100,
                          width: 200,
                          child: Center(child: Text(icecream))),
                      DragTarget(
                        builder: (
                  ...
                  Row(
                    ...
                    children: [
                      SizedBox(
                          height: 100,
                          width: 200,
                          child: Center(child: Text(oranges))),
                      DragTarget(
                        builder: (
                          BuildContext context,
                          List<dynamic> accepted,
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => L2R4Q3()));
                },
