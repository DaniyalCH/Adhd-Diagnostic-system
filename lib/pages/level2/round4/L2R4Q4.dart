...
import 'package:dyslexia/pages/level2/round5/L2R5Q1.dart';
...
class L2R4Q4 extends StatefulWidget {
  const L2R4Q4({Key? key}) : super(key: key);

  @override
  State<L2R4Q4> createState() => _L2R4Q4State();
}

class _L2R4Q4State extends State<L2R4Q4> {
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Icon(
                letter1 == climb && letter2 == ocean && letter3 == listen
                    ? TablerIcons.circle_check
                    : TablerIcons.circle_dashed,
                size: 30,
                color: letter1 == climb && letter2 == ocean && letter3 == listen
                    ? Colors.green
                    : Colors.black,
              ),
              Icon(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => L2R5Q1()));
                },
