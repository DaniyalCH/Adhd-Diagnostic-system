...
import 'dart:async';
import 'package:dyslexia/pages/level2/round5/L2R5Q3.dart';
...
class L2R5Q2 extends StatefulWidget {
  const L2R5Q2({Key? key}) : super(key: key);

  @override
  State<L2R5Q2> createState() => _L2R5Q2State();
}

class _L2R5Q2State extends State<L2R5Q2> {
  String question =
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => L2R5Q3()));
                },
