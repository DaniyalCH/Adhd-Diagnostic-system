...
import 'dart:async';
import 'package:dyslexia/pages/level2/round5/L2R5Q4.dart';
...
class L2R5Q3 extends StatefulWidget {
  const L2R5Q3({Key? key}) : super(key: key);

  @override
  State<L2R5Q3> createState() => _L2R5Q3State();
}

class _L2R5Q3State extends State<L2R5Q3> {
  String question =
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => L2R5Q4()));
                },
