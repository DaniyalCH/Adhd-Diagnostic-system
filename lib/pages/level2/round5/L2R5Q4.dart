...
import 'dart:async';
import 'package:dyslexia/pages/level1/round6/L1R6Q2.dart';
import 'package:flutter/material.dart';
import 'package:flutter_tabler_icons/flutter_tabler_icons.dart';
import 'package:audioplayers/audioplayers.dart';
import '../../../utilities/QuestionWidget.dart';

class L2R5Q4 extends StatefulWidget {
  const L2R5Q4({Key? key}) : super(key: key);

  @override
  State<L2R5Q4> createState() => _L2R5Q4State();
}

class _L2R5Q4State extends State<L2R5Q4> {
  String question =
      "Listen to this word cat. Now listen to the four words and click on the word that has the same starting sound as cat. ";
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => L1R6Q2()));
                },
