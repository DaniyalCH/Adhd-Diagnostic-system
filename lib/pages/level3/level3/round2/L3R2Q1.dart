...
class L3R2Q1 extends StatefulWidget {
  const L3R2Q1({Key? key}) : super(key: key);

  @override
  State<L3R2Q1> createState() => _L3R2Q1State();
}

class _L3R2Q1State extends State<L3R2Q1> {
  String question =
          ...
          child: Column(children: [
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Icon(
                ...
                size: 30,
                color: letter1 == "Monday" &&
                        letter2 == "Tuesday" &&
                        letter3 == "Wednesday"
                    ? Colors.green
                    : letter1 == "Tuesday" || letter1 == "Wednesday"
                        ? Colors.red
                        : Colors.black,
              ),
              Icon(
