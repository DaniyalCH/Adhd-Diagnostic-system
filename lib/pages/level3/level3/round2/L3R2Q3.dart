...
import 'package:dyslexia/pages/level3/level3/round2/L3R2Q4.dart';
...
class L3R2Q3 extends StatefulWidget {
  const L3R2Q3({Key? key}) : super(key: key);

  @override
  State<L3R2Q3> createState() => _L3R2Q3State();
}

class _L3R2Q3State extends State<L3R2Q3> {
  String question =
          ...
          child: Column(children: [
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Icon(
                ...
                size: 30,
                color: letter1 == "Wednesday" &&
                        letter2 == "Thursday" &&
                        letter3 == "Friday"
                    ? Colors.green
                    : letter1 == "Thursday" || letter1 == "Friday"
                        ? Colors.red
                        : Colors.black,
              ),
              Icon(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => L3R2Q4()));
                },
