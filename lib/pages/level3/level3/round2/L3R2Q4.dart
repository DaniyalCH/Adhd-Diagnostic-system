...
class L3R2Q4 extends StatefulWidget {
  const L3R2Q4({Key? key}) : super(key: key);

  @override
  State<L3R2Q4> createState() => _L3R2Q4State();
}

class _L3R2Q4State extends State<L3R2Q4> {
  String question =
          ...
          child: Column(children: [
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Icon(
                ...
                size: 30,
                color: letter1 == "Sunday" &&
                        letter2 == "Monday" &&
                        letter3 == "Tuesday"
                    ? Colors.green
                    : letter1 == "Monday" || letter1 == "Tuesday"
                        ? Colors.red
                        : Colors.black,
              ),
            ]),
