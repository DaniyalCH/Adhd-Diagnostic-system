...
class L3R4Q1 extends StatefulWidget {
  const L3R4Q1({Key? key}) : super(key: key);

  @override
  State<L3R4Q1> createState() => _L3R4Q1State();
}

class _L3R4Q1State extends State<L3R4Q1> {
  String question =
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Icon(
                letter1 == "May" && letter2 == "June" && letter3 == "July"
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => L3R4Q2()));
                },
