...
import 'package:dyslexia/pages/level3/level3/round4/L3R4Q4.dart';
...
class L3R4Q3 extends StatefulWidget {
  const L3R4Q3({Key? key}) : super(key: key);

  @override
  State<L3R4Q3> createState() => _L3R4Q3State();
}

class _L3R4Q3State extends State<L3R4Q3> {
  String question =
          ...
          child: Column(children: [
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Icon(
                ...
                size: 30,
                color: letter1 == "January" &&
                        letter2 == "February" &&
                        letter3 == "March"
                    ? Colors.green
                    : letter1 == "February" || letter1 == "March"
                        ? Colors.red
                        : Colors.black,
              ),
              Icon(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => L3R4Q4()));
                },
