...
import 'package:dyslexia/pages/level3/level3/round5/L3R5Q3.dart';
...
class L3R5Q2 extends StatefulWidget {
  const L3R5Q2({Key? key}) : super(key: key);

  @override
  State<L3R5Q2> createState() => _L3R5Q2State();
}

class _L3R5Q2State extends State<L3R5Q2> {
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Icon(
                letter1 == mike && letter2 == mice && letter3 == dancing
                    ? TablerIcons.circle_check
                    : TablerIcons.circle_dashed,
                size: 30,
                color: letter1 == mike && letter2 == mice && letter3 == dancing
                    ? Colors.green
                    : Colors.black,
              ),
              Icon(
              ...
              child: InkWell(
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => L3R5Q3()));
                },
