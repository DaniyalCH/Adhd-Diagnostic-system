...
import 'package:dyslexia/pages/level3/level3/round5/L3R5Q4.dart';
...
class L3R5Q3 extends StatefulWidget {
  const L3R5Q3({Key? key}) : super(key: key);

  @override
  State<L3R5Q3> createState() => _L3R5Q3State();
}

class _L3R5Q3State extends State<L3R5Q3> {
  ...
  var clown = "clown and a cat";
  var cat = "cat looking up";
  var dog = "dog on a sledge";
  ...
  Widget build(BuildContext context) {
    pic1 = Image(
      image: AssetImage("assets/images/$clown.png"),
      height: 90,
      width: 80,
    );
    pic2 = Image(
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Icon(
                letter1 == clown && letter2 == dog && letter3 == cat
                    ? TablerIcons.circle_check
                    : TablerIcons.circle_dashed,
                size: 30,
                color: letter1 == clown && letter2 == dog && letter3 == cat
                    ? Colors.green
                    : Colors.black,
              ),
              Icon(
            ...
            Material(
              ...
              child: InkWell(
                onTap: () {
                  if (letter1 == clown && letter2 == dog && letter3 == cat) {
                    correctAns += 1;
                  } else {
                    incorrectAns += 1;
                  }
                  ...
                  Navigator.of(context).pushReplacement(
                      MaterialPageRoute(builder: (context) => L3R5Q4()));
                },
